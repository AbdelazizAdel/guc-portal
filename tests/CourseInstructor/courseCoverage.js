...
describe('Testing Course Coverage route',()=>{
    ...
    it('A case where the instructor is assigned to multiple courses',async ()=>{
        ...
        const member2 =await createStaffMamber('Hany5','Hany@yahoo.com','ashduia','Hany Shawky','male',5600,3,'C2.305',6,[],undefined,true,[],true,'dep1');
        const member3 =await createStaffMamber('sherif','sherif@yahoo.com','ashduia','sherif ayman','male',3000,3,'C5.305',6,[],undefined,true,[],true,'dep1');
        const member4 =await createStaffMamber('mazen','mazen@yahoo.com','ashduia','Mazen Ibrahim','male',1000,3,'C1.205',6,[],undefined,true,[],true,'dep1');
        const member5 =await createStaffMamber('abdelaziz99','abdelaziz@yahoo.com','ashduia','Abdelaziz Ibrahim','male',1000,3,'C1.205',6,[],undefined,true,[],true,'dep2');
        const member6 =await createStaffMamber('ziad','ziad@yahoo.com','ashduia','Ziad Ibrahim','male',1000,3,'C1.205',6,[],undefined,true,[],true,'dep1');
        const member7 =await createStaffMamber('sarah','sarah@yahoo.com','ashduia','Sarah Ibrahim','female',1000,3,'C1.205',6,[],undefined,true,[],true,'dep1');
        ...
        const department2 = createDepartment('dep2','Math','abdelaziz99');
        // const response = await request.post('/login').send({email : member.email, password :'ashduia' });
        // const token = response.headers.auth_token;
        const course1 = createCourse('course1','Advanced Computer Lab','Mervat22',['Hany5','sherif'],['Ashry19'],10,'dep1');
        const course2 = createCourse('course2','SoftwareEngineering','Ayman6',[],['Ashry19'],0,'dep1');
        const slot1 = createSlot('slot1',2,1,'C7.301','Lab','course2','Ashry19');
        const slot2 = createSlot('slot2',1,1,'C7.304','Lab','course1','Ashry19');
        const slot3 = createSlot('slot3',4,3,'C2.115','Lab','course1','Ashry19');
        const slot4 = createSlot('slot4',2,3,'C2.115','Lab','course1','Hany5');
        const slot5 = createSlot('slot5',1,5,'C6.115','Lab','course1','Ashry19');
        await faculty.save();
